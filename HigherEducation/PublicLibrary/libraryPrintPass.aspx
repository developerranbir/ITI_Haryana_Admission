...
<body>
    <form id="form2" runat="server">
        <div class="pass-container">
            <!-- Header Section -->
            <div class="header">
                <asp:Image ID="imgLogo" runat="server" CssClass="iti-logo" 
                    ImageUrl="images/Logo_ITI.png" AlternateText="ITI Logo" />
                <div class="iti-name"><asp:Label ID="InstituteName" runat="server"></asp:Label> </div>
                <div class="pass-title">Library PASS</div>
            </div>

            <!-- Subscription ID -->
            <div class="subscription-id">
                Pass ID: <asp:Label ID="lblSubscriptionId" runat="server" Text=""></asp:Label>
            </div>
