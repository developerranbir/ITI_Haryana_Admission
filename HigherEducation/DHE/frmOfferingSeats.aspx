<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="frmOfferingSeats.aspx.cs" Inherits="HigherEducation.HigherEducations.frmOfferingSeats" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Physical Counselling</title>
    <meta charset="utf-8" />
        ...
        <div>
            <asp:UpdatePanel ID="updone" runat="server">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-12 top-heading text-center">
                            <div class="row">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-10 col-10">
                                    <h4 class="heading">Physical Counselling</h4>
                                </div>
                        ...
                        <div id="dvSection" runat="server" style="display: none;">
                            <div class="row">
                                ...
                                <div id="dvTopFivePercentage" runat="server" class="col-lg-4 col-md-4 col-sm-6 col-12">
                                    <label class="cus-select-label">10th/10+2/Diploma Percentage(Highest):</label><br />
                                    <asp:Label ID="lblTopFivePercentage" runat="server"></asp:Label>
                                </div>
                                <div id="dvWeightage" runat="server" class="col-lg-4 col-md-4 col-sm-6 col-12" style="display:none">
                                ...
                                <div id="dvTweleveHaryana" runat="server" class="col-lg-4 col-md-4 col-sm-6 col-12">
                                    <label class="cus-select-label">Is 12th/Diploma from Haryana:</label><br />
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="row">
                                ...
                                <div id="dvCatgSeatAllotment" runat="server" class="col-lg-6 col-md-6 col-sm-6 col-12 m-b-10" style="display: none">
                                    ...
                                    <label class="cus-select-label" style="color: red; font-weight: 700; font-size: 14px;">(Please choose very carefully. The ITI shall be solely responsible)</label>
                                    <asp:DropDownList ID="ddlCatgAllotment" runat="server" CssClass="form-control">
                                        ...
                                        <asp:ListItem Text="OPEN GEN" Value="OPENGEN"></asp:ListItem>
                                        <asp:ListItem Text="OPEN GEN-ESM" Value="OPENGENESM"></asp:ListItem>
                                        <asp:ListItem Text="BC" Value="BC"></asp:ListItem>
                                        <asp:ListItem Text="ESM-BC" Value="ESMBC"></asp:ListItem>
                                        <asp:ListItem Text="SC" Value="SC"></asp:ListItem>
                                        <asp:ListItem Text="ESM-SC" Value="ESMSC"></asp:ListItem>
                                        <asp:ListItem Text="EWS" Value="EWS"></asp:ListItem>
                                        <asp:ListItem Text="PH" Value="PH"></asp:ListItem>
              ...
              <%--                  <div id="dvPMSSCScholarShip" runat="server" class="col-lg-6 col-md-6 col-sm-6 col-12 m-b-10" style="display: none" >
                                    <label class="cus-select-label" style="color: #492A7F; font-weight: 700; font-size: 14px;">Is IMC Paid or Not:</label><span style="color: red">*</span>
                                    <asp:RadioButtonList ID="rdbtnPMS_SC" runat="server" RepeatDirection="Horizontal">
                                     ...
                                     <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="rdbtnPMS_SC"
                                        CssClass="badge badge-danger"  ErrorMessage="Please Select IMS" ValidationGroup="A"></asp:RequiredFieldValidator>
                                ...
                                <div id="dvEligibleForPMSBenefits" runat="server" class="col-lg-12 col-md-12 col-sm-12 col-12 m-b-10" style="display: none" >
                                    <label class="cus-select-label" style="color: #492A7F; font-weight: 700; font-size: 14px;">  Whether Private ITI accepts the undertaking/affidavit given by the candidate for payment of part of fee equal to PMS benefits after receiving his/her PMS benefits.</label><%--<br/>--%>

                 <label class="cus-select-label" style="color: #492A7F; font-weight: 700; font-size: 14px;"> क्या निजी आईटीआई उम्मीदवार के पीएमएस लाभ प्राप्त करने के बाद पीएमएस लाभ के बराबर फीस के भाग का भुगतान के लिए दी गई अंडरटेकिंग/शपथ पत्र को स्वीकार करती  है।:</label><span style="color: red">*</span>
                                    <asp:RadioButtonList ID="rdbtnEligibleForPMS" runat="server" RepeatDirection="Horizontal" >
                                        <asp:ListItem Text="Yes" Value="Yes"></asp:ListItem>
                                        <asp:ListItem Text="No" Value="No"></asp:ListItem>
                                    </asp:RadioButtonList>
                                     <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="rdbtnEligibleForPMS"
                                        CssClass="badge badge-danger"  ErrorMessage="Please Select PMS" ValidationGroup="A"></asp:RequiredFieldValidator>
                        ...
                        <div id="dvGrdCourseSection" class="col-lg-12 col-md-12 col-sm-12 col-12 table-responsive" runat="server" style="display: none;">
                            <div class="cus-grid-table">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <input type="text" id="myInput" onkeyup="myFunctions()" placeholder="Search Trade Name..." class="form-control" title="Type Registration ID" />
                                    </div>
                                    <div class="col-lg-6">
                                        <input type="text" id="myInputName" onkeyup="myFunctionsName()" placeholder="Search Section Name..." class="form-control" title="Type Name" />
                                    </div>
                                        ...
                                        <asp:GridView ID="GrdCourseSection" AutoGenerateColumns="false" runat="server" CssClass="table table-bordered table-hover" Style="width: 100%; margin-top: 20px;">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Subject Combination">
                                                    ...
                                                    <asp:TemplateField HeaderText="ispaid" Visible="false">
                                                    <ItemTemplate>
                        ...
                        <div id="dvGrdCourseSection2" class="col-lg-12 col-md-12 col-sm-12 col-12 table-responsive" runat="server" style="display: none;">
                            <div class="cus-grid-table">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <input type="text" id="myInput2" onkeyup="myFunctions2()" placeholder="Search Trade Name..." class="form-control" title="Type Registration ID" />
                                    </div>
                                    <div class="col-lg-6">
                                        <input type="text" id="myInputName2" onkeyup="myFunctionsName2()" placeholder="Search Section Name..." class="form-control" title="Type Name" />
                                    </div>
                                </div>
                                <div class="col-lg-12">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-12 text-center cus-getbtn" id="dvChangeOffer" runat="server" style="margin-bottom: 4%; display: none;">
                            <asp:Button ID="btnChangeOffer" runat="server" CssClass="btn btn-success" Text="Change Offer" ToolTip="If the Student wish to change the trade offer same can be done using change offer" OnClick="btnChangeOffer_Click" ValidationGroup="B" />
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-12 text-center cus-getbtn" id="dvSave" runat="server" style="margin-bottom: 4%; display: none;">
                            ...
                            <asp:Button ID="btnCancel" runat="server" CssClass="btn btn-primary" Text="Clear" OnClick="btnCancel_Click" />
                        </div>
...
<script>
    function myFunctions() {
        ...
        table = document.getElementById("GrdCourseSection");
    ...
    function myFunctions2() {
        ...
        filter = input.value.toUpperCase();
        table = document.getElementById("GrdCourseSection2");
        tr = table.getElementsByTagName("tr");
        for (i = 0; i < tr.length; i++) {
            td = tr[i].getElementsByTagName("td")[0];
            if (td) {
    ...
    function myFunctionsName2() {
        var input, filter, table, tr, td, i, txtValue;
        input = document.getElementById("myInputName2");
        filter = input.value.toUpperCase();
        table = document.getElementById("GrdCourseSection2");
        tr = table.getElementsByTagName("tr");
        for (i = 0; i < tr.length; i++) {
