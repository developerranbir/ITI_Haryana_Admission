<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="frmResetStudentPass.aspx.cs" Inherits="HigherEducation.HigherEducations.frmResetStudentPass" %>
    ...
    <script>
        function ConfirmOnChange() {
            ...
            if (validated) {
                ...
                if (confirm("Do you want to Reset Password of the student?") == true)
                    return true;
                else
                    return false;
            }
                ...
                <ContentTemplate>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-12 top-heading text-center">
                            <div class="row">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-10 col-10">
                                    <h4 class="heading">Reset Student Password</h4>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-6 ">
                                 ...
                                 <div class="col-lg-2 col-md-2">
                                    ...
                                    <label class="cus-select-label">Admission Year:<span style="color: red">*</span></label>
                                </div>
                                <div class="col-lg-3 col-md-3 col-sm-3 ">
                                    <asp:DropDownList ID="ddlAdmissionYear" CssClass="form-control"  runat="server">
                                        <asp:ListItem Text="Select Year" Value=""></asp:ListItem>
                                      
                                    </asp:DropDownList>
                                     <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="ddlAdmissionYear"
                                        CssClass="badge badge-danger" Display="Dynamic" ErrorMessage="Please Select Admission Year" ValidationGroup="B" ></asp:RequiredFieldValidator>
                    ...
                    <div id="dvEmailId" runat="server" style="display:none" class="col-lg-4 col-md-4 col-sm-6 col-12">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-12 text-center cus-getbtn" id="dvSave" runat="server" style="margin-bottom: 8%; display: none;">
                            ...
                            <asp:Button ID="btnSave" runat="server" CssClass="btn btn-success" Text="Reset Password" OnClick="btnSave_Click"  OnClientClick="ConfirmOnChange();" ValidationGroup="A" />
