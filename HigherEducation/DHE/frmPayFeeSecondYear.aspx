<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="frmPayFeeSecondYear.aspx.cs" Inherits="HigherEducation.HigherEducations.frmPayFeeSecondYear" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Get Second Year Student Details</title>
    <meta charset="utf-8" />
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-12 top-heading text-center">
                            <div class="row">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-10 col-10">
                                    <h4 class="heading">Student Details of Second Year 2021-23</h4>
                                </div>
