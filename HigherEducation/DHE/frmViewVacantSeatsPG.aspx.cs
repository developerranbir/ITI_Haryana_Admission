...
{
    public partial class frmViewVacantSeatsPG : System.Web.UI.Page
    {
        ...
        protected void btSearch_Click(object sender, EventArgs e)
        {
            ...
            if (ddlCollege.SelectedValue != "0")
            {
                ...
                if (dt.Tables.Count > 0)
                {
                    ...
                    Int64 Vacant_totalseats = dt.Tables[0].AsEnumerable().Sum(row => row.Field<Int64>("Vacant_totalseats"));
                    Int64 Vacant_SportsSeat = dt.Tables[0].AsEnumerable().Sum(row => row.Field<Int64>("Vacant_SportsSeat"));
                    ...
                    GridView2.FooterRow.Cells[3].Text = Vacant_totalseats.ToString();
                    //GridView2.FooterRow.Cells[4].Text = Vacant_SportsSeat.ToString();
