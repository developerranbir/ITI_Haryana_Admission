<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="feedetail.aspx.cs" Inherits="HigherEducation.HigherEducations.feedetail" %>
            ...
            <div class=" cus-fee-top-section">
                <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 col-12 m-b-10 cus-gobtn" style="margin-top: 30px">
                            <input type="button" id="btnGo" class="btn btn-primary" value="Go" title="Go" onclick="javascript:GetFreezeData();  " />
                        </div>
                    </div>

                    <div class="col-lg-12 col-md-12 col-sm-12 col-12 cus-sub-table-section table-responsive" id="dvView">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-12 top-section-btn text-center" id="dvSave" style="margin-bottom: 4%;">
                       <%-- <div>
                          <input type="checkbox" id="freezechk" name="freeze" value="F"/>
                          <label for="freezechk"> I certify that fee & fund details, given/submitted/entered/provided by me in respect of my institution, are in order, checked and verified by me.</label>
                    </div>--%>
                        <a href="#" id="btnsave" class="btn btn-icon icon-left btn-success"><i class="fas fa-save"></i>&nbsp;Save Data</a>
                         <%--  <a href="#" id="btnfreeze" class="btn btn-icon icon-left btn-primary"><i class="fas fa-save"></i>&nbsp;Freeze Data</a>--%>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#ddlCollege').on('change', function () {
                var Typestate = $(ddlCollege).val();
                var dropDown = document.getElementById("ddlSession");
                dropDown.selectedIndex = 0;

                var Course = document.getElementById("ddlCourse");
            ...
            $('#btnfreeze').on('click', function () {
                ...
                if (atLeastOneIsChecked > 0) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: '/api/v1/Fees/SaveFreezeData',
                        dataType: 'JSON',
        ...
        function GetSection() {
            ...
            $.ajax({
                url: "/api/v1/Fees/GetSection",
                type: "GET",
                contentType: "application/json;charset=utf-8",
                data: { "Courseid": $('#ddlCourse').val(), "Sessionid": $('#ddlSession').val(), "collageIdystate": $('#ddlCollege').val()},
                dataType: "json",
                success: function (data) {
...
`);
        ...
        function GetFeeDetailData() {
            ...
            $.ajax({
                url: "/api/v1/Fees/GetFeeDetailData",
                type: "GET",
                contentType: "application/json;charset=utf-8",
                data: { "Collegeid": $('#ddlCollege').val(), "Sessionid": $('#ddlSession').val() },
                dataType: "json",
