<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ForgetPassword.aspx.cs" Inherits="HigherEducation.HigherEducations.ForgetPassword" %>
...
<head id="Head1" runat="server">
    ...
    <script language="Javascript" type="text/javascript">
        ...
        //    if (document.getElementById('txtturing').value == "") {
    ...
    <div class="container-fluid">
        <div class="row main-banner" >   
         ...
         <div class="col-lg-12 col-md-12 col-sm-12 col-12 text-right back-btn" style="margin-top: 5px;">
					<a href="frmlogin.aspx" id="btnBack" class="btn btn-info"><i class="fas fa-lock"></i>&nbsp;Login</a>
				</div>
        <div class="d-flex justify-content-center">
            <div class="cus-login-div login-box">
                ...
                <div class="col-lg-12 cus-sub-heading">
                  ...
                  <%--  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 cus-input-labels">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 cus-input-values">
                        <asp:TextBox ID="txtUserId" placeholder="Enter your Used ID" runat="server" MaxLength="50" class="form-control" ></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtUserId"
                            ErrorMessage="Please enter User Id" SetFocusOnError="True" class="badge badge-danger"
                        ...
                        <asp:RegularExpressionValidator ID="revUseralphanum" runat="server" ControlToValidate="txtUserId"
                            ValidationExpression="^[A-Za-z0-9@.]{5,50}$" ErrorMessage="Please enter valid User Id"
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 cus-inputs">
                   <%-- <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 cus-input-labels">
                        <asp:Label ID="lblNewPassword" Text="New Password" runat="server" Visible="false"></asp:Label>
                    </div>--%>
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 cus-input-values">
                        <asp:TextBox ID="txtNewPassword" runat="server" MaxLength="50" Visible="false" TextMode="Password" placeholder="Enter your New Password"></asp:TextBox>
                        <%-- <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtNewPassword"
                            ErrorMessage="Please enter New Password" class="label label-danger" SetFocusOnError="True"
                            ValidationGroup="ResetP" Display="Dynamic" ForeColor=""></asp:RequiredFieldValidator>--%>
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtNewPassword"
                            SetFocusOnError="true" ErrorMessage="Invalid Password" class="badge badge-danger"
                            ValidationExpression="^[A-Za-z0-9$#@$]{6,50}$" ValidationGroup="ResetP" Display="Dynamic"
                            ForeColor=""></asp:RegularExpressionValidator>
                    </div>
                </div>
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 cus-inputs">
                  <%--  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 cus-input-labels">
                        <asp:Label ID="lblCNewPassword" Text="Confirm New Password" runat="server" Visible="false"></asp:Label>
                    </div>--%>
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 cus-input-values">
                        <asp:TextBox ID="txtCNewPassword" runat="server" MaxLength="50" Visible="false" TextMode="Password" placeholder="Confirm New Password"></asp:TextBox>
                        <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtCNewPassword"
                            ErrorMessage="Please enter Confirm New Password" class="label label-danger" SetFocusOnError="True"
                            ValidationGroup="ResetP" Display="Dynamic" ForeColor=""></asp:RequiredFieldValidator>--%>
                        <%--<asp:CompareValidator ID="valcCNPassword" runat="server" SetFocusOnError="true" ControlToValidate="txtCNewPassword"
                            class="label label-warning" ControlToCompare="txtNewPassword" Type="String" ValidationGroup="ResetP"
                            Display="Dynamic" ErrorMessage="New Password and Confirm Password must be same"
                            ForeColor=""></asp:CompareValidator>--%>
                        <%--</div> 
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 cus-input-values" style="margin-top: 10px;">--%>
                        <asp:RegularExpressionValidator class="badge badge-danger" ID="RegularExpressionValidator2"
                            runat="server" ControlToValidate="txtCNewPassword" SetFocusOnError="true" ErrorMessage="Invalid Password"
                            ValidationExpression="^[A-Za-z0-9$#@$]{6,50}$" ValidationGroup="ResetP" Display="Dynamic"
                            ForeColor=""></asp:RegularExpressionValidator>
                    </div>
                     <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="dvNote" runat="server" style="margin-top:10px;">
                         <h6 style="font-size:12px;"><span style="color:#E91E63;font-weight:800;">Note:&nbsp;</span>Password must be between 6 and 15 characters; must contain at least one alphabet letter, one numeric digit, and one special character ($,# or @)</h6>
                    </div>
                </div>

                 <div id="dvCaptcha" runat="server" style="padding: 0;">
							<div class="row cus-captchalist">
								...
								<div class="col-lg-1 col-md-1 col-sm-6 col-4 login-captcha">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center" style="margin-bottom: 5px;">
                    <asp:Label ID="lblError" class="badge badge-danger" runat="server" Style="line-height: 18px;
                        font-size: 12px;" Visible="false" />
                    <asp:Label ID="lblSMsg" class="badge badge-success" runat="server" Style="line-height: 18px;
                        font-size: 12px;" Visible="false" />
                </div>


                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center cus-bttns-div">
                    <asp:Button ID="btnSubmit" Text="Send Reset Link" class="btn btn-primary btn-md" runat="server"
