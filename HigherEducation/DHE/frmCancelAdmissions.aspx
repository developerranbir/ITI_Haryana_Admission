<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="frmCancelAdmissions.aspx.cs" Inherits="HigherEducation.HigherEducations.frmCancelAdmissions" %>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-12 top-heading text-center">
                <div class="row">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-10 col-10">
                        <h4 class="heading">Cancellation of Student's Admission</h4>
                    </div>
            ...
            <div class="cus-top-section" style="margin-top: 20px;">
                <div class="row">
                     <div class="col-lg-5 col-md-5"> 
                        <label class="cus-select-label">Registration Id/Roll No:<span style="color: red">*</span></label>
                    </div>
              ...
              <div class="row">
                  ...
                  <div id="dvCollege" runat="server" style="display:none;" class="col-lg-4 col-md-4 col-sm-6 col-12">
                    ...
                    <div id="dvSectionName" runat="server" style="display:none;" class="col-lg-4 col-md-4 col-sm-6 col-12">
                        <label class="cus-select-label">Trade Section:</label><br />
               ...
               <div id="dvCancel" class="col-lg-12 col-md-12 col-sm-12 col-12" runat="server" style="display:none;">
                   <div class="row">
                       <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                           <label class="cus-select-label" style="color: #492A7F; font-weight: 700; font-size: 14px;">Is SLC Bogus:</label><span style="color: red">*</span>
                                    <asp:RadioButtonList ID="rdbtnSLC" runat="server" RepeatDirection="Horizontal">
                                        <asp:ListItem Text="Yes" Value="Y"></asp:ListItem>
                                        <asp:ListItem Text="No" Value="N"></asp:ListItem>
                                    </asp:RadioButtonList>
                                     <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="rdbtnSLC"
                                        CssClass="badge badge-danger"  ErrorMessage="Please Select SLC Bogus" ValidationGroup="A"></asp:RequiredFieldValidator>
                       </div>
