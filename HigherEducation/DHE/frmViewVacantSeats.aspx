<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="frmViewVacantSeats.aspx.cs" Inherits="HigherEducation.HigherEducations.frmViewVacantSeats" %>
    ...
    <form id="form1" runat="server">
                ...
                <div class="col-xl-10 col-lg-10 col-md-10 col-sm-12 col-12">
                    <nav class="nav-menu d-none d-lg-block">
                        <ul>
                            ...
                            <li class="active"><a href="frmViewVacantSeats.aspx"><span class="english">View Vacant Seats</span><span class="hindi" style="display: none;">रिक्त सीटें</span></a></li>
        ...
        <div class="container-fluid">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-12 top-heading">
                <h4 class="heading">View Vacant Seats for Open Counselling</h4>
            </div>
...
<div class="col-lg-12 col-md-12 col-sm-12 col-12 text-center">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div id="dvCoursewise" runat="server" style="display:none">
                <div class="col-lg-12 col-md-12 col-sm-12 col-12 top-heading">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-12 top-heading">
                    <h4 class="heading">Subject Combinationwise Vacant Seats</h4>
                </div>
                    ...
                    <asp:GridView ID="GridView2" ShowFooter="true" runat="server" AutoGenerateColumns="false" class="table table-bordered table-striped table-hover">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Subject Combination">
                                <ItemTemplate>
                                    <asp:Label ID="lblSubjectComb" runat="server" Text='<%# Eval("subjectcombination") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Vacant Seats" ItemStyle-Font-Bold="true" ItemStyle-ForeColor="Red">
                                <ItemTemplate>
                                    <asp:Label ID="lblTotalSeats" runat="server" Text='<%# Eval("noofseats") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
