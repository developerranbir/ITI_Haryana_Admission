<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="frmVerificationRevoked.aspx.cs" Inherits="HigherEducation.HigherEducations.frmVerificationRevoked" %>
...
<head runat="server">
    ...
    <script>
       ...
       function ConfirmOnRevoked() {
            var validated = Page_ClientValidate('A');
            if (validated) {
                
                if (confirm("Do you really want to Revoke Student Verification?") == true)
                    return true;
                else
                    return false;
            }
        ...
        <div class="container-fluid">
            <div class="col-lg-12 col-md-12 col-sm-12 col-12 top-heading text-center">
                <div class="row">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-10 col-10">
                        <h4 class="heading">Revoke Verification</h4>
                    </div>
            ...
            <div class="Container" style="margin-top: 20px;">
                <div class="row">
                    <div class="col-lg-2 col-md-2"> 
                        <label class="cus-select-label" style="color: #492A7F; font-weight: 800">Registration Id/Roll No:<span style="color: red">*</span></label>
                    </div>
            ...
            <div id="dvSection" runat="server" >
              <div class="row">
               ...
               <div id="dvVerRevoked" class="col-lg-12 col-md-12 col-sm-12 col-12" runat="server" style="display:none;">
                   <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-12 cus-getbtn text-center" style="margin-top:15px;">
                        <asp:Button ID="btnVerRevoked" runat="server" CssClass="btn btn-danger btn-sm" Text="Revoke Verification"   OnClick="btnVerRevoked_Click" OnClientClick="return ConfirmOnRevoked();" ValidationGroup="A" />
                    </div>
                   </div>
                   </div>
                   </div>
