...
function Add() {
    ...
    var objMFD = {
        ...
        EmailId: $('#EmailId').val(),
        dateApproval: $('#dateApproval').val(),
        MembershipNo: $('#MembershipNo').val(),
        PFTCode: $('#PFTCode').val(),
        PFTValue: $('#PFTValue').val(),
        TowerNo: $('#TowerNo').val(),
        IsMortgage: $('#IsMortgage').val(),
        IsLitigation: $('#IsLitigation').val(),
        CourtName: $('#CourtName').val(),
        CaseInBrief: $('#CaseInBrief').val(),
        CourtNameId: $('#CourtNameId').val(),
        MortgagedDetail: $('#MortgagedDetail').val()
    };
    $.ajax({
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            if (getbySocietyMemberID.dob === "") {
                ...
                $('#datepickerdob').val(getbySocietyMemberID.Dob);
            }
            $('#dateApproval').val(getbySocietyMemberID.dateApproval);
