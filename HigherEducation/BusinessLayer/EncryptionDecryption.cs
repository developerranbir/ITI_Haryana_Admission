...
namespace HigherEducation.BusinessLayer
{
    public class EncryptionDecryption
    {
        ...
        public string EncryptKey(string textToEncrypt, string Key)
        {
            RijndaelManaged rijndaelCipher = new RijndaelManaged();
            rijndaelCipher.Mode = CipherMode.CBC;
            rijndaelCipher.Padding = PaddingMode.PKCS7;
        ...
        public string Decrypt(string textToDecrypt, string FilePath)
        {
            ...
            string strToreturn = Encoding.UTF8.GetString(plainText);
            return strToreturn;
        }
        public string DecryptKey(string textToDecrypt, string Key)
        {
            RijndaelManaged rijndaelCipher = new RijndaelManaged();
            rijndaelCipher.Mode = CipherMode.CBC;
            rijndaelCipher.Padding = PaddingMode.PKCS7;
