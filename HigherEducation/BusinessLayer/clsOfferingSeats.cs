...
namespace HigherEducation.BusinessLayer
{
    ...
    public class clsOfferingSeats
    {
        ...
        public string EligibleForPMS { get; set; }
        ...
        public DataTable GetOfferingStudentInfo()
        {
            ...
            try
            {
                ...
                MySqlDataAdapter vadap = new MySqlDataAdapter("GetOfferingStudentInfo", vconnHE_ReadOnly);
                vconnHE_ReadOnly.Open();
        ...
        //checkseatfreeze
        public DataTable checkseatfreeze()
        {
            ...
            try
            {
                ...
                MySqlDataAdapter vadap = new MySqlDataAdapter("checkseatfreeze", vconnHE_ReadOnly);
                vconnHE_ReadOnly.Open();
        ...
        //checkcoursesection
        public DataTable checkcoursesection()
        {
            ...
            try
            {
                ...
                MySqlDataAdapter vadap = new MySqlDataAdapter("checkcoursesection", vconnHE_ReadOnly);
                vconnHE_ReadOnly.Open();
            ...
            catch (Exception ex)
            {
                clsLogger.ExceptionError = ex.Message;
                clsLogger.ExceptionPage = "DHE/BusinessLayer/clsOfferingSeats";
                clsLogger.ExceptionMsg = "checkcoursesection";
                clsLogger.SaveException();
            }
            if (vconnHE_ReadOnly.State == ConnectionState.Open)
                vconnHE_ReadOnly.Close();
        ...
        public DataTable GetCourseSectionDetails()
        {
            ...
            try
            {
                ...
                MySqlDataAdapter vadap = new MySqlDataAdapter("GetCourseSectionDetails_ITI_Open1", vconnHE_ReadOnly);
                vconnHE_ReadOnly.Open();
                vadap.SelectCommand.Parameters.AddWithValue("@P_RegId", RegId);
                vadap.SelectCommand.Parameters.AddWithValue("@p_Collegeid", Collegeid);
                vadap.SelectCommand.CommandTimeout = 600; // 10 minutes
        ...
        public DataTable GetCategoryWiseVacantSeat()
        {
            ...
            try
            {
                ...
                MySqlDataAdapter vadap = new MySqlDataAdapter("GetCategoryWiseVacantSeat", vconnHE_ReadOnly);
                vconnHE_ReadOnly.Open();
            ...
            catch (Exception ex)
            {
                clsLogger.ExceptionError = ex.Message;
                clsLogger.ExceptionPage = "DHE/BusinessLayer/clsOfferingSeats";
                clsLogger.ExceptionMsg = "GetCategoryWiseVacantSeat";
                clsLogger.SaveException();
            }
            if (vconnHE_ReadOnly.State == ConnectionState.Open)
                vconnHE_ReadOnly.Close();
        ...
        //Get GetAdmissionStatus
        public DataSet GetAdmissionStatus()
        {
            ...
            try
            {
                ...
                MySqlDataAdapter vadap = new MySqlDataAdapter("GetCandidateAlloCollegeList", vconnHE_ReadOnly);
                vconnHE_ReadOnly.Open();
                vadap.SelectCommand.Parameters.AddWithValue("@P_reg_id", RegId);
            ...
            catch (Exception ex)
            {
                clsLogger.ExceptionError = ex.Message;
                clsLogger.ExceptionPage = "DHE/BusinessLayer/clsOfferingSeats";
                clsLogger.ExceptionMsg = "GetAdmissionStatus";
                clsLogger.SaveException();
            }
            if (vconnHE_ReadOnly.State == ConnectionState.Open)
                vconnHE_ReadOnly.Close();
        ...
        public DataTable GetSeatallotment_open1()
        {
            ...
            try
            {
                ...
                MySqlDataAdapter vadap = new MySqlDataAdapter("GetSeatallotment_open1", vconnHE_ReadOnly);
                vconnHE_ReadOnly.Open();
                vadap.SelectCommand.Parameters.AddWithValue("@p_RegId", RegId);
                vadap.SelectCommand.Parameters.AddWithValue("@p_collegeid", Collegeid);
            ...
            catch (Exception ex)
            {
                clsLogger.ExceptionError = ex.Message;
                clsLogger.ExceptionPage = "DHE/BusinessLayer/clsOfferingSeats";
                clsLogger.ExceptionMsg = "GetSeatallotment_open1";
                clsLogger.SaveException();
            }
            if (vconnHE_ReadOnly.State == ConnectionState.Open)
                vconnHE_ReadOnly.Close();
        ...
        public string SaveOfferSeats()
        {
            ...
            try
            {
                ...
                vadap.SelectCommand.Parameters.AddWithValue("@p_EligibleForPMS", EligibleForPMS);
                vadap.SelectCommand.CommandTimeout = 600; // 10 minutes
                vadap.SelectCommand.CommandType = CommandType.StoredProcedure;
                vadap.Fill(vds);
                if (vconnHE.State == ConnectionState.Open)
