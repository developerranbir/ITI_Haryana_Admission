...
{
    public class QuarterlyFeeController : Controller
    {
        ...
        public ActionResult QuarterlyFee()
        {
            ...
            try
            {
                ...
                ObjfeeModule = EducationContext.GetCandidateForQuarterFee(regId);
            ...
            catch (Exception ex)
            {
                ...
                logger.Error(ex, "Error occured in HigherEducation.QuarterlyFeeController.[HttpGet] QuarterlyFee(),'" + regId + "'");
            }
        ...
        public ActionResult PartialFeeView(string collegeid,string QNo)
        {
            ...
            try
            {
                ...
                ObjfeeModule = EducationContext.GetCandidateFeeDetailQ(regId, collegeid,QNo);
                clsSecurity.SetCookie();
            }
        ...
        public ActionResult FeeRequest(FeeModule feeModule)
        {
            try
            {
                ...
                ObjfeeModule1 = EducationContext.GetCandidateFeeDetailQ(regId, feeModule.merchant_param3,feeModule.QtrNo);
                ...
                ObjfeeModule1.redirect_url = WebConfigurationManager.AppSettings["redirect_url_ITI_Q"];  //M
                ObjfeeModule1.cancel_url = WebConfigurationManager.AppSettings["cancel_url_ITI_Q"];   // M
                ...
                result = EducationContext.SaveFeeModuleforQuarterFee(ObjfeeModule1);
        ...
        public ActionResult FeeResponse(FeeModule feeModule)
        {
            ...
            {
                string result;
                result = ObjregistrationFeeDB.QuarterFeeSuccess(objPayment);
            ...
            {
                string result;
                result = ObjregistrationFeeDB.QuarterFeeFailure(objPayment);
        ...
        //    {
        //        logger = LogManager.GetLogger("databaseLogger");
        //        logger.Error(ex, "Error occured in HigherEducation.QuarterlyFeeController.[HttpGet] FeeModuleCollegePartial(),'" + regId + "'");
        //    }
        //    return View(ObjfeeModule1);
        //}
