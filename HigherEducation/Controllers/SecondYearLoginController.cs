...
{
    public class SecondYearLoginController : Controller
    {
        ...
        public ActionResult Login(FormCollection formCollect)
        {
            try
            {
                if (this.IsCaptchaValid("Validate your captcha"))
                {
                    ...
                    if (formCollect.Get("student_name") != "")
                    {
                        var r = @"^[a-zA-Z0-9\s]*$";

                        Regex regex = new Regex(r);
                        ret = regex.IsMatch(formCollect.Get("student_name"));
                        if (!ret)
                        {
                            resultcount += 1;
                            MsgText += "Invalid Student Name" + Environment.NewLine;
                        }
                    }
                    ...
                    if (resultcount > 0)
                    {
                        ...
                        return RedirectToAction("Login", "SecondYearLogin");
                    }
                    ...
                    objDetail.CandidateName = formCollect.Get("student_name");
                    objDetail.rno = Convert.ToString(Session["rno"]);

                    bool IsUserExits = objInfo.ValidateUserSecondYear(objDetail);

                    if (IsUserExits)
                    {
                        objDetail.RegID= objInfo.getRegIDSecondYear(objDetail);
                    }
                    ...
                    if (Session["RegId"] == null)
                    {
                        if (IsUserExits & IsLogin > 0)
                        {
                            ...
                            return RedirectToAction("QuarterlyFee", "SecondYearLogin");
                        }
            ...
            catch (Exception ex)
            {
                ...
                logger.Error(ex, "Error occured in HigherEducation.SecondYearLoginController.[HttpPost] Login()");
            }
            return View();
        ...
        public ActionResult LogOut()
        {
            ...
            return RedirectToAction("Login", "SecondYearLogin", new { area = "" });
        }
        ...
        public ActionResult QuarterlyFee()
        {
            ...
            try
            {
                ...
                ObjfeeModule = EducationContext.GetCandidateForQuarterFeeSecondYear(regId);
            ...
            {
                logger = LogManager.GetLogger("databaseLogger");
                logger.Error(ex, "Error occured in HigherEducation.SecondYearLoginController.[HttpGet] QuarterlyFee(),'" + regId + "'");
            }
            clsSecurity.SetCookie();
        ...
        public ActionResult PartialFeeView(string collegeid, string QNo)
        {
            ...
            try
            {
                ...
                ObjfeeModule = EducationContext.GetCandidateFeeDetailSQ(regId, collegeid,QNo);
                clsSecurity.SetCookie();
            }
        ...
        public ActionResult FeeRequest(FeeModule feeModule)
        {
            try
            {
                ...
                ObjfeeModule1 = EducationContext.GetCandidateFeeDetailSQ(regId, feeModule.merchant_param3, feeModule.QtrNo);
                ...
                ObjfeeModule1.redirect_url = WebConfigurationManager.AppSettings["redirect_url_ITI_SQ"];  //M
                ObjfeeModule1.cancel_url = WebConfigurationManager.AppSettings["cancel_url_ITI_SQ"];   // M
                ...
                result = EducationContext.SaveFeeModuleforSecondYear(ObjfeeModule1);
            ...
            {
                logger = LogManager.GetLogger("databaseLogger");
                logger.Error(ex, "Error occured in HigherEducation.SecondYearLoginContoller.[HttpPost] FeeRequest()" + feeModule.RegistrationId);
            }
            return View();
        }
        [HttpPost]
        public ActionResult FeeResponse(FeeModule feeModule)
        {
            ...
            {
                string result;
                result = ObjregistrationFeeDB.SecondYearQuarterFeeSuccess(objPayment);
            ...
            {
                string result;
                result = ObjregistrationFeeDB.SecondYearQuarterFeeFailure(objPayment);
        ...
        public ActionResult FeeReceipt(string paymentTransactionId = "")
        {
            ...
            try
            {
                ...
                ObjfeeModule1 = EducationContext.GetCandidatePaymentSuccesDetailSecondYear(regid, paymentTransactionId);
            }
            catch (Exception ex)
            {

                logger = LogManager.GetLogger("databaseLogger");
                logger.Error(ex, "Error occured in HigherEducation.SecondYearLoginContoller.[HttpGet] FeeReceipt(),'" + regid + "'");
            }
            return View(ObjfeeModule1);
        }
        ...
        public JsonResult ConfirmSeatofSCCandidate(SCCandidateFee item)
        {
            ...
            {
                logger = LogManager.GetLogger("databaseLogger");
                logger.Error(ex, "Error occured in HigherEducation.SecondYearLoginContoller.[HttpGet] ConfirmSeatofSCCandidate()" + item.RegistrationId);
        ...
        public ActionResult PartialCandidateView()
        {
            ...
            try
            {
                ...
                ObjfeeModule = EducationContext.GetCandidateDetailsSecondYear(regId);
                clsSecurity.SetCookie();
            }
        ...
        public JsonResult changeCandidatePassword(String DATA)
        {
            try
            {
                ...
                if (Session["regid"] == null || Session["regid"].ToString() == "")
                {
                    ...
                    result = objInfo.updatePasswordSecondYear(Session["regid"].ToString(), sb.ToString());
