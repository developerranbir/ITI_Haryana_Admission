...
{
    public class CondidateDetailsITIWiseController : Controller
    {
        Logger logger = LogManager.GetCurrentClassLogger();
        CondidateDetailsITIWiseContext objCondidateDetails = new CondidateDetailsITIWiseContext();
...
public ActionResult CondidateDetailsITIWise()
        {
            return View();
        }
        [HttpGet]
        public JsonResult getCollegeListAsPerCollegeType(String collegeType)
        {
            ...
            try
            {
                ...
                dt = objCondidateDetails.getCollegeListAsPerCollegeType(collegeType);//collegeid and courseId
        ...
        public JsonResult GetTradeListByITI(String collegeId)
        {
            ...
            try
            {
                dt = objCondidateDetails.GetTradeListByITI(collegeId);//collegeid and courseId
        ...
        public JsonResult GetSectionList(String CollegeId, String CourseId)
        {
            ...
            dt = objCondidateDetails.GetSectionList(CollegeId, CourseId);//collegeid and courseId

            return Json(Newtonsoft.Json.JsonConvert.SerializeObject(dt), JsonRequestBehavior.AllowGet);
        }
        [HttpPost]
        public JsonResult getStudentDetails(String collegeId, String courseId, String sectionId)
        {
            DataSet dt = new DataSet();
            try
            {
                ...
                {
                    dt = objCondidateDetails.getStudentDetailsList(collegeId, courseId, sectionId);
                }
                else
                {
                    TempData.Clear();
